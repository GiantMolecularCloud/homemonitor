...
def dashboard_plotly():
    ...
    image_24h  = os.path.join('logs','home.24h.svg')
    image_corr = os.path.join('logs','home.hist.svg')
...
def plotting_stats():
    """ Thread for plotting """
    while _plotting:
        generate_plots()            # function to be written in plots.py
        time.sleep(28800)           # render figures every 8h
